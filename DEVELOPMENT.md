...
#### 9.1.1 注册新用户
1. 访问系统登录页面：`http://your-domain.com/login`
2. 点击"立即注册"按钮，进入注册页面
3. 填写用户名、密码、邮箱等信息
4. 点击"注册"按钮，完成注册
...
#### 9.2.4 批量删除书签
1. 在书签列表中，勾选需要删除的多个书签
2. 点击"批量删除"按钮
3. 在确认弹窗中点击"确定"，完成批量删除

### 9.3 安装程序管理

#### 9.3.1 上传安装程序
1. 点击左侧菜单"资源管理" -> "安装程序管理"
2. 点击"上传文件"按钮
3. 选择需要上传的安装程序文件
4. 填写文件版本、平台和描述信息
5. 点击"确定"按钮，完成文件上传
...
#### 9.3.2 下载安装程序
1. 在安装程序列表中，找到需要下载的文件
2. 点击"下载"按钮，开始下载文件

#### 9.3.3 管理安装程序
1. 可以编辑安装程序的版本、平台和描述信息
2. 可以删除不需要的安装程序
3. 支持批量删除安装程序

### 9.4 资源压缩包管理

1. 点击左侧菜单"资源管理" -> "资源压缩包管理"
2. 点击"上传文件"按钮，上传资源压缩包
3. 在文件列表中可以查看、下载和管理压缩包文件
...
#### 9.7.2 查看绩效统计
1. 在绩效记录与统计页面，可以选择时间范围（本周、本月、自定义）
2. 可以查看绩效总和、考勤天数和日均绩效
3. 可以查看绩效趋势图

### 9.8 生产项目配置

#### 9.8.1 添加生产项目
1. 在绩效记录与统计页面，点击"生产项目配置"按钮
2. 填写项目编码、项目名称、作业额定效率和质检额定效率
3. 点击"确定"按钮，完成生产项目添加
...
#### 9.9.1 添加加班记录
1. 在绩效记录与统计页面，点击"加班汇报"按钮
2. 点击"添加加班记录"按钮
3. 选择汇报日期，填写加班小时数、项目名称和加班描述
4. 点击"确定"按钮，完成加班记录添加
...
1. 点击页面右上角的用户头像
2. 选择"反馈"选项
3. 选择反馈类型，填写反馈内容和联系方式
4. 点击"提交"按钮，完成反馈提交

#### 9.11.2 管理员处理反馈
1. 管理员登录后，点击左侧菜单"系统管理" -> "反馈管理"
2. 在反馈列表中，可以查看用户反馈
3. 点击"编辑"按钮，处理和回复反馈
4. 可以更新反馈状态
5. 支持删除和批量删除反馈
...
1. 点击左侧菜单"实用工具" -> "音乐工具"
2. 在搜索框中输入关键词，搜索音乐
3. 在搜索结果中，点击歌曲名称，开始播放音乐
4. 可以切换到歌词、MV或评论标签页

#### 9.12.2 天气工具
1. 点击左侧菜单"实用工具" -> "天气工具"
2. 选择省份和城市
3. 查看所选城市的天气状况、温度、湿度等信息
...
| 1.5.0 | 2026-02-10 | 新增详细的使用教程，涵盖系统登录与注册、书签管理、安装程序管理、资源压缩包管理、财务管理、绩效管理、日常绩效记录、生产项目配置、加班汇报、薪资记录管理、反馈管理、实用工具和管理员用户管理等所有功能模块的使用说明；更新项目文档章节编号，调整整体结构 |
